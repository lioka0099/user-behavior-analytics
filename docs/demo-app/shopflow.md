...
<img src="{{ '/assets/ShopFlow_Homescreen.jpg' | relative_url }}" alt="ShopFlow Home screen" width="300" />

### Product view

<img src="{{ '/assets/ShopFlow_ProductView.jpg' | relative_url }}" alt="ShopFlow Product view" width="300" />

### Shopping cart

<img src="{{ '/assets/Shopflow_ShoppingCart.jpg' | relative_url }}" alt="ShopFlow Shopping cart" width="300" />

### Checkout

<img src="{{ '/assets/Shopflow_Checkout.jpg' | relative_url }}" alt="ShopFlow Checkout" width="300" />
